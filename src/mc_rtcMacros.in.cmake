...
macro(add_controller controller_name)
  ...
  install(TARGETS ${controller_name}
    ARCHIVE DESTINATION "${MC_CONTROLLER_LIBRARY_INSTALL_PREFIX}"
    LIBRARY DESTINATION "${MC_CONTROLLER_LIBRARY_INSTALL_PREFIX}"
    RUNTIME DESTINATION "${MC_CONTROLLER_RUNTIME_INSTALL_PREFIX}"
  )
endmacro()
